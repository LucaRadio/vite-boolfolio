    ...
    <div class="row justify-content-center p-3">
        <div class="col-4">
            <div class="card text-white bg-dark mb-3">
                ...
                <img v-if="singleProject.img_cover" class="card-img-top"
                    :src="`${baseUrl}/storage/${singleProject.img_cover}`" alt="Card image cap">
                <div class="card-body">
                    ...
                    <div class="card-text">
                        ...
                        <div class="card-text" v-else>
                            <ul>
                                <li class="text-danger" v-if="singleProject.technologies"
                                    v-for="item in technologiesToPrint">{{ item }}</li>
                            </ul>
                        </div>
                    </div>
