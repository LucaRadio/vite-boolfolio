...
<template>
        ...
        <div class="row justify-content-center p-3" >
            ...
            <div class="card text-white bg-dark mb-3">
                ...
                <img v-if="singleProject.img_cover" class="card-img-top" :src=" `${baseUrl}/storage/${singleProject.img_cover}`" alt="Card image cap">
                <div class="card-body">
                  ...
                  <div class="card-text">
                    Used technologies:
                    <div class="card-text" v-if="singleProject.length<1">There's no Information</div>
                    <div class="card-text" v-else>
                        <ul>
                            <li class="text-danger" v-if="singleProject.technologies" v-for="item in technologiesToPrint">{{item }}</li>
                        </ul>
                    </div>
                  </div>
