  ...
  <div class="container">
    <nav aria-label="Page navigation example">
      <ul class="pagination mt-5 mb-0 d-flex justify-content-center">
        ...
        <li class="page-item" v-for="index in totalPage" @click="fetchScopedPage(index)"><button
            :class="(currentPage === index) ? 'bg-primary text-white' : ''" class="page-link"> {{ index }}</button></li>
